...
namespace VD2.Models
{
    public class EmployeeDbContext : DbContext
    {
        ...
        public DbSet<VD2.Models.EmployeeViewModel> EmployeeViewModel { get; set; }
        public DbSet<VD2.Models.EmployeeCreateModel> EmployeeCreateModel { get; set; }
        public DbSet<VD2.Models.EmployeeEditModel> EmployeeEditModel { get; set; }
    }
}
